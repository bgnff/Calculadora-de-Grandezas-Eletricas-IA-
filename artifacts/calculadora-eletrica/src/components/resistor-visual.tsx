...
export function ResistorVisual({ bands }: ResistorVisualProps) {
  ...
  return (
    <div className="relative flex min-h-[192px] items-center justify-center overflow-hidden rounded-2xl bg-[#edf4f4] px-4" data-testid="visual-resistor">
      <div className="absolute inset-0 bg-[#eaf2ff] opacity-60" aria-hidden="true" />
      <svg viewBox="0 0 520 190" className="relative z-10 w-full max-w-[450px]" role="img" aria-label="Visual do resistor de quatro faixas">
        <path d="M18 95 H132 M388 95 H502" stroke="#9daabd" strokeWidth="8" strokeLinecap="round" />
        <path d="M132 69 C132 48 151 35 174 35 H346 C369 35 388 48 388 69 V121 C388 142 369 155 346 155 H174 C151 155 132 142 132 121 Z" fill="#e9e5d7" stroke="#b8ae9a" strokeWidth="2" />
