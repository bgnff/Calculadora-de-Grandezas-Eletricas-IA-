...
const clerkAppearance = {
  ...
  variables: {
    colorPrimary: '#087c9f',
    colorForeground: '#183044',
    colorMutedForeground: '#61757d',
    colorDanger: '#b04f4c',
    colorBackground: '#ffffff',
    colorInput: '#fbfdfd',
    colorInputForeground: '#183044',
    colorNeutral: '#d6e2e3',
  ...
  elements: {
    ...
    headerTitle: 'font-display text-[#183044]',
    headerSubtitle: 'text-[#61757d]',
    socialButtonsBlockButtonText: 'text-[#183044]',
    formFieldLabel: 'text-[#183044]',
    footerActionLink: 'text-[#087c9f]',
    footerActionText: 'text-[#61757d]',
    dividerText: 'text-[#61757d]',
    formFieldSuccessText: 'text-[#287b76]',
    alertText: 'text-[#b04f4c]',
    logoBox: 'rounded-xl overflow-hidden',
    socialButtonsBlockButton: 'border-[#d6e2e3] hover:bg-[#f2f8f7]',
    formButtonPrimary: 'bg-[#087c9f] hover:bg-[#126d91] text-white',
    formFieldInput: 'border-[#d6e2e3] bg-[#fbfdfd] text-[#183044]',
    footerAction: 'bg-transparent',
    dividerLine: 'bg-[#d6e2e3]',
    alert: 'bg-[#fff6f5] border-[#efcfcc]',
    otpCodeFieldInput: 'border-[#d6e2e3]',
    formFieldRow: 'gap-2',
    main: 'bg-transparent',
  },
};
...
function LandingPage() {
  return (
    <main className="min-h-[100dvh] overflow-hidden bg-[hsl(var(--background))]">
      <div className="pointer-events-none absolute -right-24 -top-32 size-[34rem] rounded-full bg-[#d7f3f0]/70 blur-3xl" />
      <header className="relative mx-auto flex max-w-6xl items-center justify-between px-5 py-6 md:px-10 md:py-8">
        ...
        <div className="flex items-center gap-2">
          ...
          <a href={`${basePath}/sign-up`} className="rounded-xl bg-[hsl(var(--primary))] px-4 py-2.5 text-sm font-bold text-white transition hover:bg-[#126d91]">Criar conta</a>
        </div>
      </header>
      <section className="relative mx-auto grid max-w-6xl items-center gap-12 px-5 pb-16 pt-12 md:grid-cols-[1.05fr_0.95fr] md:px-10 md:pb-28 md:pt-20">
        <div>
          <p className="mb-5 inline-flex items-center gap-2 rounded-full border border-[#cde4df] bg-[#eef8f5] px-3 py-1.5 text-xs font-bold uppercase tracking-[0.13em] text-[#287b76]"><span className="size-1.5 rounded-full bg-[#39aaa6]" /> Clareza para cada grandeza</p>
          <h1 className="max-w-3xl font-display text-[clamp(3rem,7vw,5.8rem)] font-semibold leading-[0.94] tracking-[-0.075em] text-[hsl(var(--foreground))]">Energia bem entendida muda decisões.</h1>
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row"><a href={`${basePath}/sign-up`} className="inline-flex items-center justify-center gap-2 rounded-xl bg-[hsl(var(--primary))] px-5 py-3.5 text-sm font-bold text-white shadow-[0_12px_24px_hsl(var(--primary)/.2)] transition hover:-translate-y-0.5 hover:bg-[#126d91]">Começar agora <span aria-hidden="true">→</span></a><a href={`${basePath}/sign-in`} className="inline-flex items-center justify-center rounded-xl border border-[hsl(var(--border))] bg-white px-5 py-3.5 text-sm font-bold text-[hsl(var(--foreground))] transition hover:border-[#a8c6c3]">Já tenho uma conta</a></div>
        ...
        <div className="relative">
          <div className="absolute inset-8 rounded-[32px] bg-[#a7ded8]/30 blur-2xl" />
          <div className="soft-shadow relative rounded-[28px] border border-[#c9e3df] bg-white p-5 sm:p-7">
            <div className="flex items-center justify-between border-b border-[hsl(var(--border))] pb-5"><Brand compact /><span className="rounded-full bg-[#eaf7f4] px-2.5 py-1 text-[10px] font-bold uppercase tracking-[0.12em] text-[#287b76]">Ao vivo</span></div>
            <p className="mt-7 text-xs font-bold uppercase tracking-[0.14em] text-[hsl(var(--muted-foreground))]">Calculadora elétrica</p>
            <div className="mt-3 rounded-2xl bg-[#edf8f5] p-5"><p className="text-sm font-medium text-[#347d78]">Resultado de resistência</p><div className="mt-2 flex items-end gap-2"><strong className="font-data text-5xl font-medium tracking-[-0.08em] text-[#156e70]">600</strong><span className="mb-1 font-data text-base text-[#4c8d8a]">Ω</span></div><p className="mt-4 border-t border-[#cde9e2] pt-3 font-data text-xs text-[#568b88]">R = V ÷ I · 12 V ÷ 0,02 A</p></div>
