...
-- Observação: Em instâncias Supabase reais, os dados estão atrelados ao auth.users.
-- Este seed pode ser utilizado após a criação de um usuário inicial.
-- Exemplo de inserção condicional se existir algum usuário registrado:
